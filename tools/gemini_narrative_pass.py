...
def main() -> int:
    ...
    system = (
        ...
        "      STORY'S VOICE. Your narration MUST carry its content — weave it in\n"
        "      near-verbatim (it is usually the best line in the group). NEVER skip a\n"
        "      caption; it outranks describing the artwork.\n"

...
def main() -> int:
    ...
    system = (
        ...
        "    When two panels show the SAME moment, KEEP the one with the most COMPLETE framing —\n"
        "    full faces/figures, properly composed — and mark the cropped/partial one (a face or\n"
        "    body cut off at a panel edge, a sliver, a stitch-seam fragment) 'redundant'.\n"

...
def normalize_manifest(m: Any) -> List[Dict[str, Any]]:
    ...
    raise SystemExit("vision manifest format not recognized (expected list or dict containing a list)")
    ...
    for fp in files:
        ...
        try:
            ...
            for b in cand_raw:
                ...
                # - ring is not bright (dark/colored bg), or
                # - ring saturation is high (colored bg/effects)
                sfx_like = (

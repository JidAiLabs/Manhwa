...
def inject_missing_protected(
    ...
    Post-merge-off (C1, script_expander.tts_merge_short=False) this injects ONLY
    narration-less protected/system cards (story panels keep their own per-panel
    segments), so it no longer causes the flash and remains REQUIRED to show
    system/title cards (else system_card_unshown).
    """

...
SYSTEM = (
    ...
    "    'chrome' = PUBLICATION/PLATFORM furniture, never the story world: the series "
    "COVER, an EPISODE/CHAPTER-NUMBER card, a creator/site/publisher LOGO or watermark "
    "(e.g. a '…toon.com' end-card), a 'thanks for reading / subscribe / follow / join "
    "our Discord' promo, an app-store/UI screen, or credits. Chrome is about the "
    "WEBSITE / APP / RELEASE — NOT the characters or their world.\n"
    ...
    "    'story' = the STORY WORLD — real scene art AND in-world INFO CARDS: a "
    "character name / AGE / TIME card (e.g. 'LIN ZICHEN - AGE: 5 MONTHS'), an RPG "
    "STATUS / SKILL / STAT window, a SYSTEM message, or a place / organization name "
    "(e.g. 'SKY CORPORATION'). These carry story and MUST be kept. When unsure, 'story'.\n"
